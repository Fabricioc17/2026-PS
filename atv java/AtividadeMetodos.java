public class AtividadeMetodos {
    ...
    // 🧩 Problema 4 — Sobrecarga de Soma (Método 1 - int)
    public static int somar(int a, int b) {
        return a + b;
    }

    // 🧩 Problema 4 — Sobrecarga de Soma (Método 2 - double)
    public static double somar(double a, double b) {
        return a + b;
    }

    // 🧩 Problema 5 — Sistema de Cardápio com Sobrecarga (Método 1)
    public static void exibirProduto(String nome) {
        System.out.println("Produto: " + nome);
    }

    // 🧩 Problema 5 — Sistema de Cardápio com Sobrecarga (Método 2)
